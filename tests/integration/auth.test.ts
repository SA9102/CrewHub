...
describe("organisation + owner creation", () => {
  ...
  //   expect(res.status).toBe(400)
  // })
  // it("should create an organisation and its owner in the database if all inputs are valid", async () => {
  //   const data = {
  //     organisationName: "Acme LTD",
  //     firstName: "john",
  //     lastName: "smith",
  ...
  //   expect(await bcrypt.compare(data.password, user?.password!)).toEqual(true)
  //   const organisation = await prisma.organisation.findUnique({
  //     where: {
  //       id: user?.organisationId,
  //     },
  //   })
  //   expect(organisation).not.toBe(null)
  //   expect(organisation?.id).toEqual(user?.organisationId)
  //   expect(organisation?.name).toEqual(data.organisationName)
  //   // Cleanup - delete test user and organisation from database
